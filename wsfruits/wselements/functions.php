    ...
    <div class="thumbnail" style="padding: 10px;">
        <div style="height:230px;">
            <a target="_blank" href="item.php?id={$row['product_id']}" >
                <img width="100" src="../wselements/{$product_photo}" alt="">
                <strong>{$row['product_title']}</strong>
            </a>
        </div>
        <div class="caption"  style="height: 80px; margin-top: 20px">
            <h4 class="pull-right">&#36;{$row['product_price']}</h4>
            <p>{$row['short_desc']}.</p>
        </div>
        <div> 
        <a class="btn btn-primary" target="_blank" href="..\wselements\cart.php?add={$row['product_id']}" text-align:center>Add To Cart</a> 
    </div>
        </div>
 </div>
DELIMETER;
...
function get_products_in_category_page()
{
 ...
 <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail" style="padding: 10px">
                <div style="height: 230px">
                    <a target="_blank" href="item.php?id={$row['product_id']}" ><img width ='100' src="../wselements/{$product_photo}" alt=""></a>
                 </div>  
                     ...
                     <div>   
                            <a href="..\wselements\cart.php?add={$row['product_id']}" class="btn btn-primary">Buy Now!</a>
                     </div>
                </div>
            </div>
DELIMETER;
...
function get_products_in_shop_page()
{
 ...
 <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail" style="padding: 10px;">
                <div style="height: 230px">
                    <a target="_blank" href="item.php?id={$row['product_id']}" ><img height ="100%" src="../wselements/{$product_photo}" alt=""></a>
                  </div> 
                    <div>
                    <div class="caption" style="height:120px">
                        <h4>{$row['product_title']}</h4>
...
function display_order()
{
    ...
    <tr>
        ...
        <td><a class = "btn btn-danger" href ="..\..\wselements\ktemplates\backend\delete_order.php?id={$row['order_id']}"><span class ="glyphicon glyphicon-remove"></span></a>        
        </td>
    </tr>
DELIMETER;
        echo $orders;
...
function get_products_in_admin()
{
    ...
    while ($row = fetch_array($query)) {
        ...
        <tr>
            ...
            <td><a href="index.php?edit_product&id={$row['product_id']}"><p>{$row['product_title']}</p></a><div><img width='100' src="../../wselements/uploads/{$product_photo}" alt=""></div></td>
            <td>{$category}</td>
            <td>&#165;{$row['product_price']}</td>
            <td>{$row['product_quantity']}</td>
            <td>
            <a class="btn btn-danger" href = "..\..\wselements\ktemplates\backend\delete_product.php?id={$row['product_id']}"><span class = " glyphicon glyphicon-remove"></span></a>
            </td>
       </tr>
...
<tr>
    <td>{$cat_id}</td>
    <td>{$cat_title}</td>
    <td><a class="btn btn-danger" href = "..\..\wselements\ktemplates\backend\delete_category.php?id={$row['cat_id']}"><span class = " glyphicon glyphicon-remove"></span></a></td>
</tr>
DELIMETER;
...
<tr>
    ...
    <td>{$username}</td>
     <td>{$email}</td>
    <td><a class="btn btn-danger" href="..\..\wselements\ktemplates\backend\delete_user.php?id={$row['user_id']}"><span class="glyphicon glyphicon-remove"></span></a></td>
</tr>
...
function get_current_slide_in_admin()
{
    ...
    <img width='800' height='300' class="img-responsive" src="../../wselements/{$slide_image}" alt="">
DELIMETER;
...
function get_active_slide()
{
 ...
 <div class="item active">
    <img width='800' height='300' class="slide-image" src="../wselements/{$slide_image}" alt="">
</div>
DELIMETER;
        echo $slide_active;
    }
...
<div class="col-xs-6 col-md-3 image_container">
    ...
    <a href="index.php?delete_slide_id={$row['slide_id']}">
         ...
         <img width='800' height='300' class="img-responsive slide_image" src="../../wselements/{$slide_image}" alt="">
