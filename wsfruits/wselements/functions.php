        ...
        <a target="_blank" href="item.php?id={$row['product_id']}" ><img width ='100' src="../wselements/{$product_photo}" alt=""></a>
            <div class="caption">
               ...
               <h4> <a target="_blank" href="item.php?id={$row['product_id']}" >{$row['product_title']}</a></h4>
                 ...
                 </div> <a class="btn btn-primary" target="_blank" href="..\wselements\cart.php?add={$row['product_id']}" text-align:center>Add To Cart</a> </div>
 </div>
DELIMETER;
echo $products;
    }
...
$category_page = <<< DELIMETER
 <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    <img src="../wselements/{$product_photo}" alt="">
                    <div class="caption">
                        <h3>{$row['product_title'] }</h3>
                        <p>{$row['short_desc'] }</p>
                        <p>
                            <a href="..\wselements\cart.php?add={$row['product_id']}" class="btn btn-primary">Buy Now!</a> <a href="item.php?id={$row['product_id']}" class="btn btn-default">More Info</a>
                        </p>
                    </div>
                </div>
            </div>
