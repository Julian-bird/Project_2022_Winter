...
<div class="row">
    ...
    <div class="col-md-7">
       <img class="img-responsive" src="..\wselements\<?php echo  display_images($row['product_image']);?>" alt="" >
    ...
    <form action="">
        <div class="form-group">
            ...
            <a href="..\wselements\cart.php?add=<?php echo $row['product_id'];?>" class="btn btn-primary">ADD TO CART</a>
        </div>
    </form>
